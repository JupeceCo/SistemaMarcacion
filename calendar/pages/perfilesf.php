                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="d-flex flex-column card-header">
                                    ...
                                    <span class="btn  btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalForm" style="width: 150px;" onclick="limpiarModal()">Agregar Usuario</span>
                                </div>
                                <!-- Card Header -->

                                <div class="p-3 panel-body table-responsive" id="listaservicio">
                        ...
                        <form id="modalFormPlanilla">
                            <div class="row">
                                ...
                                <div class="col-md-10 col-sm-12  form-group">
                                    <select id="perfil" name="perfil" class="select2"> </select>
                                </div>
                                ...
                                <div class="col-md-10 col-sm-12  form-group">
                                    <input style="text-align: center; text-transform: uppercase;" minlength="8" maxlength="8" placeholder="" id="dni" name="dni" class="form-control">
                                </div>
                                ...
                                <div class="col-md-10 col-sm-12  form-group">
                                    <input style="text-align: center; text-transform: uppercase;" placeholder="" value="../dist/img/User_icon_2.jpg" type="hidden" id="foto" name="foto" class="form-control">
                                </div>
