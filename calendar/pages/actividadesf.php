                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="d-flex flex-column card-header">
                                    <h3 class="card-title mb-3">Actividades</h3>
                                    <span class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalForm" style="width: 150px;" onclick="limpiarModal()">Agregar Actividades</span>
                                </div>
                                <!-- /.card-header -->

                                <div class="p-3 panel-body table-responsive" id="listadoactividades">
