                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="d-flex flex-column card-header">
                                    <h3 class="card-title mb-2">Áreas</h3>
                                    <span class="btn  btn-primary btn-sm" style="width: 110px;" data-toggle="modal" data-target="#exampleModalForm" onclick="limpiarModal()">Agregar Área</span>
                                </div>
                                <div class="p-3 panel-body table-responsive" id="listadoarea">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="padding: 0.2rem">
                        <h5 class="modal-title" id="exampleModalFormTitle" style="padding: 0.7rem">Registro de Área</h5>
                        ...
                        <form id="modalFormPlanilla">
                            <div class="row">
                                ...
                                <div class="col-md-10 col-sm-12  form-group">
                                    <select id="servicio" name="servicio" class="select2"></select>
                                </div>
    ...
    <script>
        ...
        $(function() {
            ...
            $('#modalFormPlanilla').validate({
                ...
                messages: {
                    servicio: {
                        required: "Seleccione un servicio válido"
                    },
                    descripcion: {
