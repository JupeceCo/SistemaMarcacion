...
<body class="hold-transition sidebar-mini sidebar-collapse" style="overflow-x:hidden;">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header p-3">
                                    <h3 class="card-title">Reporte de Programación</h3> &nbsp; &nbsp;

                                    <form id="reporte" class="form-inline ml-3 mt-4" style="margin-left: 0rem !important">
                                        <div class="input-group input-group-sm" style="margin:4px 0;">
                                            <label>Mes:</label>
                                        </div>  
                                        <div class="col-md-2 col-sm-12  form-group" style="margin:4px 0;">
                                        ...
                                        <div class="col-md-4 col-sm-12  form-group" style="margin:4px 0;">
