...
<body class="hold-transition sidebar-mini sidebar-collapse">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-header p-3">
                                    <h3 class="card-title">Reporte de Actividades</h3> &nbsp; &nbsp;
                                    <form class="form-inline ml-3 mt-4" style="margin-left: 0rem !important">
                                        ...
                                        <div class="col-md-4 col-sm-12  form-group">
                                            <select class="select2" style="width: 100%" name="cmbdepartamento" id="cmbdepartamento">
                                            </select>
                                        </div>
                                    ...
                                    <div class="panel-body table-responsive mt-3" id="listasreporte">
    ...
    <script src="../dist/js/bundleReporteActividades.js"></script>
    <script>
        //Date range picker
