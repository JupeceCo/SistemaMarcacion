                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="d-flex flex-column card-header">
                                    <h3 class="card-title mb-2">Servicios</h3>
                                    <span class="btn  btn-primary btn-sm" style="width: 150px;" data-toggle="modal" data-target="#exampleModalForm" onclick="limpiarModal()">Agregar Servicio</span>
                                </div>
                        ...
                        <form id="modalFormPlanilla">
                            <div class="row">
                                ...
                                <div class="col-md-10 col-sm-12  form-group">
                                    <select id="departamento" name="departamento" class="select2"></select>
                                </div>
