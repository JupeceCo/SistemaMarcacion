...
<body class="hold-transition sidebar-mini sidebar-collapse">
    ...
    <div class="wrapper">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                ...
                                <div class="d-flex flex-column card-header">
                                    <h3 class="card-title mb-2">Grupo de Riesgo</h3>
                                    <span class="btn  btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalForm" style="width: 180px;" onclick="limpiarModal()">Agregar Grupo de Riesgo</span>
                                </div>
                                <!-- Card Header -->

                                <div class="p-3 panel-body table-responsive" id="listadoriesgo">
        ...
        <!-- Form Modal Registro Grupo Riesgo-->
