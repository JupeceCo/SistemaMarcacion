            ...
            <div class="col-md-11">
                <form class="form-inline ml-3" style="margin-left: 0rem !important">
                    ...
                    <div class="col-md-4 col-sm-12  form-group">
                        <select class="select2" style="width: 100%" name="cmbdepartamento" id="cmbdepartamento" onchange="listadoServicios(), cargarcalendar(), listadoPersonal()"></select>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body" style="overflow-y:scroll; padding: 0.5rem; max-height:450px;">
                                    <!-- the events -->
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="card card-primary card-outline">
                                        <div class="card-header">
                                            <h4 class="card-title">
                                                <i class="far fa-calendar-alt"></i> Calendario de Registro de Programación
                                        ...
                                        <div class="card-body table-responsive p-0">
                                            <table class="table table-hover text-nowrap" id="tablacontenedor" name="tablacontenedor">
                                                <thead>
                                                    <tr>
                    ...
                    <div class="modal-body" style="padding: 0.2rem">
                        <form>
                            <div class="form-group">
                                ...
                                <div class="card">
                                    <button class="btn btn-link" type="button" id="btnreg" style="background-color: #3c8dbc; color: #ffffff" onclick="mostrarmodel()">
                                    ...
                                    <div id="panelidentificar" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        <div class="card-body" style="padding: 0.7rem">
                                            <div class="form-group" style="margin-bottom: 0.2rem">
                                                ...
                                                <select class="form-control select2bs4" style="width: 100%" id="cmbpersonal"></select>
                                            </div>
                                            <div class="form-group" style="margin-bottom: 0.2rem">
                                                <label>Turno</label>
                                                <select class="form-control select2bs4" style="width: 100%" id="cmbturnos"></select>
                                            </div>
                                            <div class="form-group" style="margin-bottom: 0.2rem">
                                                <label>Hora Ingreso:</label>
                                                <select class="form-control select2bs4" style="width: 100%" id="cmbHoras"></select>
                                            </div>

                                            <div class="form-group" style="margin-bottom: 0.2rem">
                                                <label>Área:</label>
                                                <select class="form-control select2bs4" style="width: 100%" id="cmbarea"></select>
                                            </div>

                                            <div class="form-group" style="margin-bottom: 0.2rem">
                                                <label>Modalidad:</label>
                                                <select class="form-control select2bs4" style="width: 100%" id="cmbmodalidad"></select>
                                            </div>

                                            <div class="form-group" style="margin-bottom: 0.2rem">
                                                <label for="exampleInputEmail1">Programados en el Area</label>
                                                <table class="table table-sm" id="tablaProgramadoServicio">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 10px">#</th>
                                                            <th>Usuario</th>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button id="btngrabarhorario" type="button" class="btn btn-primary btn-pill" style="width: 100%" onclick="RegistroHorarioProgramacion()">
                                                    Guardar
                                                </button>
                                            </div>
                                        </div>
