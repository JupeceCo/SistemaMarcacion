...
<body class="hold-transition sidebar-mini sidebar-collapse">
    ...
    <div class="wrapper">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="d-flex flex-column card-header">
                                    <h3 class="card-title mb-2">Relación de Puestos de trabajo</h3>
                                    <span class="btn  btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalForm" style="width: 180px;" onclick="limpiarModal()">Agregar Puesto de trabajo</span>
                                </div>
        ...
        <!-- Form Modal Registro Puestos Trabajo -->
                        ...
                        <form id="modalFormPlanilla">
                            ...
                            <div class="row">
                                <div class="col-md-2 col-sm-12  form-group ">
                                    <label class="col-form-label">ID Puesto de Trabajo</label>
                                </div>
