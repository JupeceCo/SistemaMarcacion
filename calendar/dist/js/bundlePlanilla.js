      ...
      if (r.success == true) {
        ...
        _datares.forEach((elemento, indice) => {
          ...
          $.ajax({
            ...
            processData: false,
            success: function (r) {
            $('#area').prepend("<option value>Seleccione un Área</option>");
...
function getPersonal(){
    ...
    success: function (r) {
          ...
          $('#personal').prepend("<option value>Seleccione un Personal</option>");
            $.each(r.dataResult, function(index, item) {
...
success: function (r) {
    ...
    $('#grupo').prepend("<option value>Seleccione un Grupo Riesgo</option>");
      $.each(r.dataResult, function(index, item) {
          $('#grupo').append($('<option />', {
              text: item.descripcion,
              value: item.id
...
function getServicio(){
  ...
  $.ajax({
    ...
    success: function (r) {
        ...
        $('#servicio').prepend("<option value>Seleccione un Servicio</option>");
          $.each(r.dataResult, function(index, item) {
...
success: function (r) {
    ...
    $('#puesto').prepend("<option value>Seleccione un Puesto</option>");
      $.each(r.dataResult, function(index, item) {
...
function registrarPlanilla(){
    ...
    var dat = JSON.stringify({
      ...
      iap: $("#area").val(),
      ipt: $("#puesto").val(),
      ob: $("#observacion").val().toUpperCase(),
      fi: $("#fecini").val(),
      ff: $("#fecfin").val(),
      es: $("#estado").val(), 
    });
