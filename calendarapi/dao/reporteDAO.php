...
class reporteDAO
{
    ...
    public function consultaReporteActividadAll($departamento, $mes){
        try {

            $database = new ConexionBD();
            $sql = "SELECT per.nrodocumento, per.nombrecompleto,puesto.descripcion AS puesto, count(act.descripcion) AS actividades, rol.dia,rol.mes,rol.idestado1,rol.idestado,rol.idrol FROM p_actividad p INNER JOIN p_actividades act ON act.idactividades = p.id_actividades INNER JOIN p_rolprogramacion rol ON rol.idrol = p.idrol INNER JOIN p_planilla pla ON pla.idplanilla = rol.idplanilla INNER JOIN p_personal per ON per.idpersona = pla.idpersona INNER JOIN p_area are ON are.idarea = pla.idarea INNER JOIN p_puestotrabajo puesto ON puesto.idpuesto = pla.idpuestotrabajo INNER JOIN p_servicio ser ON ser.idservicio = pla.idservicio INNER JOIN p_unidadorganizacional dep ON dep.idundorganizacional = ser.idundorganizacional WHERE dep.idundorganizacional= :idundorganiza AND rol.mes= :mes group by rol.idrol ORDER BY rol.dia";
            // $sql = "SELECT per.nrodocumento, per.nombrecompleto,puesto.descripcion AS puesto, act.descripcion AS actividades, rol.dia,rol.mes,rol.idestado1,rol.idestado,rol.idrol
            // FROM p_actividad p
            // INNER JOIN p_actividades act ON act.idactividades = p.id_actividades
            // INNER JOIN p_rolprogramacion rol ON rol.idrol = p.idrol
            // INNER JOIN p_planilla pla ON pla.idplanilla = rol.idplanilla
            ...
            // INNER JOIN p_servicio ser ON ser.idservicio = pla.idservicio
            // INNER JOIN p_unidadorganizacional dep ON dep.idundorganizacional = ser.idundorganizacional
            // WHERE dep.idundorganizacional= :idundorganiza 
            // AND rol.mes= :mes ORDER BY rol.idrol, rol.dia";
            $database->query($sql);
            $database->bind(":idundorganiza",$departamento);
            $database->bind(":mes",$mes);
            $database->execute();
            return $database->resultSet();
    ...
    public function listarUsuarios(){
        try {
            ...
            $sql = 'SELECT COUNT(idusuario) AS "totalusuarios" FROM p_usuario';
            $database->query($sql);
            $database->execute();
            return $database->resultSet();
        } catch (Exception $ex) {
    ...
    public function listarPuestos(){
        try {
            ...
            $sql = 'SELECT COUNT(idpuesto) AS "totalpuestos" FROM p_puestotrabajo';
            $database->query($sql);
            $database->execute();
            return $database->resultSet();
        } catch (Exception $ex) {
    ...
    public function listarGrupos(){
        try {
            ...
            $sql = 'SELECT COUNT(idgruporiesgo) AS "totalgrupos" FROM p_gruporiesgo';
            $database->query($sql);
            $database->execute();
            return $database->resultSet();
        } catch (Exception $ex) {
    ...
    public function listarAreas(){
        try {
            ...
            $sql = 'SELECT COUNT(idarea) AS "totalareas" FROM p_area';
            $database->query($sql);
            $database->execute();
            return $database->resultSet();
        } catch (Exception $ex) {
    ...
    public function listarServicios(){
        try {
            ...
            $sql = 'SELECT COUNT(idservicio) AS "totalservicios" FROM p_servicio';
            $database->query($sql);
            $database->execute();
            return $database->resultSet();
        } catch (Exception $ex) {
    ...
    public function listarDepartamentos(){
        try {
            ...
            $sql = 'SELECT COUNT(idundorganizacional) AS "totaldepartamentos" FROM p_unidadorganizacional';
            $database->query($sql);
            $database->execute();
            return $database->resultSet();
        } catch (Exception $ex) {
    ...
    public function listarPlanillas(){
        try {
            ...
            $sql = 'SELECT COUNT(pl.idplanilla) AS "totalplanillas" FROM p_planilla pl';
            $database->query($sql);
            $database->execute();
            return $database->resultSet();
        } catch (Exception $ex) {
    ...
    public function listarPersonal(){
        try {
            ...
            $sql = 'SELECT COUNT(pe.idpersona) AS "totalpersonal" FROM p_personal pe';
            $database->query($sql);
            $database->execute();
            return $database->resultSet();
        } catch (Exception $ex) {
    ...
    public function listarProgramaciones(){
        try {
            ...
            $sql = 'SELECT COUNT(rp.idrol) AS "totalprogramacion" FROM p_rolprogramacion rp';
            $database->query($sql);
            $database->execute();
            return $database->resultSet();
        } catch (Exception $ex) {
    ...
    public function listarActividades(){
        try {
            ...
            $sql = 'SELECT COUNT(ac.idactividad) AS "totalactividad" FROM p_actividad ac';
            $database->query($sql);
            $database->execute();
            return $database->resultSet();
        } catch (Exception $ex) {
